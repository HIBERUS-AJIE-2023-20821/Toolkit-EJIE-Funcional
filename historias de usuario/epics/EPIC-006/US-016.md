...
1. **Bloque "Datos salvo oposición"**: Autorizaciones cuya consulta está autorizada por defecto, pero el ciudadano puede oponerse
2. **Bloque "Datos únicamente si consiente"**: Autorizaciones que requieren consentimiento explícito

Cada bloque incluye:
- Un **switch general** que afecta a todas las autorizaciones del bloque
- Un **checkbox individual** por cada autorización que se puede gestionar
- Información del **organismo cedente** de cada autorización
...
- Bloque 1: "Datos salvo oposición" con switch general y checkbox por cada autorización
- Bloque 2: "Datos únicamente si consiente" con switch general y checkbox por cada autorización
- Para cada autorización: descripción clara y organismo cedente
...
### CA-8: Visualización de organismo cedente por autorización
**Dado** que se muestra la lista de autorizaciones a gestionar en cualquier bloque  
**Cuando** el ciudadano visualiza cada autorización  
**Entonces** debe aparecer claramente:
- Nombre o descripción de la autorización
- Organismo cedente que proporciona los datos

### CA-9: Todas las autorizaciones con cedente visible
**Dado** que se presentan los bloques de autorizaciones  
**Cuando** el sistema muestra las autorizaciones a gestionar  
**Entonces** cada autorización debe indicar su organismo cedente de forma visible
